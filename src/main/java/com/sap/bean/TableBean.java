...
public class TableBean{
    ...
    public static class Country{
        ...
        public String toString(){
        	String result = "Golden: " + this.golden + " silver: " + this.silver
        			 + " copper: " + this.copper + " tank: " + this.tank;
        	return result;
        }
    }
    ...
    public static void main(String args[]){
        ...
        try {
            //TableBean bean = mapper.readValue(new File("table.json"), TableBean.class);
        	
        	// does not work if TableBean.class.getClass().getResource
        	// nullURL url = TableBean.class.getResource("\\src\\main\\java\\com\\sap\\bean\\table.jsontable.json");
